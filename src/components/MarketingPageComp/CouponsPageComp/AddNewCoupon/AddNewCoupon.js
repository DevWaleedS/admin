...
const AddNewUser = ({ cancel, couponDetails }) => {
  ...
  return (
    <div
      className="absolute pl-36 top-0 right-0  z-10 pt-5 pr-24  w-full "
    ...
    >
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-medium" style={{ fontSize: '18px', color: "#011723" }}>جدول الكوبونات</h2>
      ...
      <div className={"mt-8"}>
        ...
        <h2 style={{ fontSize: '18px', color: "#67747B" }} className="my-5">اختر نوع الخصم</h2>
            ...
            <div style={{ boxShadow: '0px 3px 6px #00000029' }} className="bg-white flex-1 rounded-lg">
              ...
              >
                ...
                <h3 className="font-medium"
                  style={{ fontSize: '24px', color: couponTypePercent ? "#fff" : "#011723" }}
                >
                  نسبة الخصم
                </h3>
              </div>
              <div className="py-6 px-5 flex flex-col gap-5">
                <div className="flex flex-col gap-[10px]">
                  <label
                    style={{ fontSize: '18px', color: couponTypePercent ? "#011723" : "#A7A7A7" }}
                  >
                    <AiFillStar
                      style={{
                        display: "inline-block",
            ...
            <div style={{ boxShadow: '0px 3px 6px #00000029' }} className="bg-white flex-1 rounded-lg">
              ...
              >
                ...
                <h3
                  ...
                  style={{ fontSize: '24px', color: couponTypePercent ? "#011723" : "#fff" }}
                >
                  مبلغ ثابت
                </h3>
              </div>
