				...
				<ImageUploading value={images} onChange={onChangeLogoImage} maxNumber={2} dataURLKey='data_url' acceptType={['jpg', 'png', 'jpeg']}>
					{({ imageList, onImageUpload, onImageRemoveAll, onImageUpdate, onImageRemove, isDragging, dragProps }) => (
						...
						>
							...
							<Button className={'mx-auto mt-9 w-[109] md:h-14 h-[45px] md:text-2xl text-[18px]'} fontSize={'text-2xl font-thin'} style={{ backgroundColor: '#02466A' }} type={'normal'}>
								حفظ
							</Button>
						</div>
					)}
