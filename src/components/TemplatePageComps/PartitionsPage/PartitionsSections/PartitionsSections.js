		...
		<Box className='pr-20 pt-5 pl-24' style={{ backgroundColor: '#FFFFFF' }}>
			<TabContext value={value}>
				<Box sx={{}}>
					...
					>
						<Tab disableRipple={true} className='text-lg font-medium' label=' المنتجات المميزة' value='1' />
						<Tab disableRipple={true} className='text-lg font-medium' label='المتاجر  المميزة' value='2' />
						<Tab disableRipple={true} className='text-lg font-medium' label='القسم الثالث' value='3' />
					</TabList>
				</Box>
