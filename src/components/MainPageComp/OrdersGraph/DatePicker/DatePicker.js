...
const DatePicker = () => {
  ...
  return (
			<LocalizationProvider dateAdapter={AdapterDayjs}>
				...
				>
					<div className='w-20 flex suffix_icon duration-200 justify-center h-[48px] p-2 items-center rounded-r-md' style={{ backgroundColor: '#02466A' }}>
						<img src={DataIcon} alt='' />
					</div>
					<DateRange.RangePicker
						className='main_page_date_picker rounded-none rounded-l-lg  mt-0  h-[48px]  w-[538px]'
						style={{
