...
function StyledTreeItem(props) {
	const { bgColor, color, svg, labelIcon: LabelIcon, labelText, ...other } = props;
		...
		>
			...
			>
				...
				<StyledTreeItem sx={{}} nodeId='2' onClick={handleExpanding('2')} labelText='السوق' svg={<Market style={{ marginLeft: 5, height: '1.2rem', zIndex: '10' }} />}>
					<Link to={'/سوق_اطلبها'}>
						<StyledTreeItem nodeId='33' labelText='سوق أطلبها' svg={<GiPlainCircle style={{ marginLeft: 5, height: '1.2rem', zIndex: '10' }} />}></StyledTreeItem>
					</Link>
					<Link to={'/السوق_العام'}>
						<StyledTreeItem nodeId='34' labelText='السوق العام' svg={<GiPlainCircle style={{ marginLeft: 5, height: '1.2rem', zIndex: '10' }} />}></StyledTreeItem>
					</Link>
					<Link to={'/المخزون'}>
						<StyledTreeItem nodeId='35' labelText='المخزون' svg={<GiPlainCircle style={{ marginLeft: 5, height: '1.2rem', zIndex: '10' }} />}></StyledTreeItem>
					</Link>
				</StyledTreeItem>
				...
				<Link to={'/المتاجر'}>
					...
					>
						<Link to={'/نشاط_المتاجر'}>
							<StyledTreeItem svg={<GiPlainCircle style={{ marginLeft: 5, height: '1.2rem', zIndex: '10' }} />} nodeId='5' labelText='نشاط المتاجر'></StyledTreeItem>
						</Link>
