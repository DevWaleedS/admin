      ...
      >
        <div className="flex h-full flex-col justify-between">
          ...
          <div
            ...
            className={`flex-1 overflow-y-scroll pl-12 py-5 pr-16 ${styles.content}`}
          >
            <div className="flex flex-col gap-4">
              <h3 style={{ color: '#011723', fontSize: '22px' }} className="font-bold">بيانات المتجر</h3>
              <div className="flex flex-row items-center">
                ...
                <input
                  className="w-[555px] py-4 px-5 rounded-md outline-none"
              ...
              <div className="flex flex-row items-center">
                ...
                <div
                  className="w-[555px] py-4 px-5 rounded-md flex flex-row items-center justify-between"
                  style={{ backgroundColor: '#EFF0F0', border: '1px solid #F0F0F0' }}
                >
                  <div className="flex flex-row items-center">
            ...
            <div className="flex flex-col gap-4 mt-4">
              <h3 style={{ color: '#011723', fontSize: '22px' }} className="font-bold">بيانات المالك</h3>
              <div className="flex flex-row items-center">
                <label className="text-lg w-[315px]">
                  الإسم الكامل
                </label>
