  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 style={{ fontSize:'',color:'#ECFEFF' }} className="md:text-[22px] text-[18px] font-medium text-center">ارسال ملاحظة</h2>
        </div>
        ...
        >
          <div style={{ backgroundColor:'#F4F5F7',border:'1px solid #67747B33' }}
            ...
            <span style={{ color:'#67747B' }} className="md:text-[20px] text-[16px] font-medium">{traderPackageDetails?.store?.store_name}</span>
          </div>
          <textarea
            style={{ color:'#67747B'}}
