		...
		<div className='md:mt-10 mt-4'>
			<div className='flex md:flex-row flex-col-reverse items-end md:gap-8 gap-4 md:bg-[#FFFFFF] bg-[#F2F8FA] rounded-lg py-4 px-2'>
				<div className='w-full flex-1 flex flex-col gap-2'>
					...
					<FormControl className='flex flex-row gap-4' sx={{ width: '100%', maxWidth: '100%', flex: '1' }}>
						<Select
							value={age}
				...
				<FormControl className='flex flex-row gap-4' sx={{ width: '474px', maxWidth: '100%', flex: '1' }}>
					<label className={`flex-1 h-14 relative `}>
						<input className='w-full h-full outline-0 pr-16 rounded-lg bg-transparent' placeholder=' ابحث عن مستخدم' type='text' name='name' onChange={() => {}} style={{ border: '1px solid #A7A7A7' }} />
