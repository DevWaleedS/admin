...
const NewProduct = ({ cancel, editProduct }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-0 left-0 bg-slate-50 z-20 otlobha_new_product ${styles.add_new_product}`}
        ...
        <div className="flex h-full flex-col justify-between">
          ...
          >
            ...
            <h2 style={{ fontSize: '20px', color: '#011723' }} className="font-normal">
              {editProduct
                ? "تعديل بيانات المنتجات في المخزون"
                : "اضافة بيانات المنتج في المخزون"}
            </h2>
          </div>
          <div
            style={{ backgroundColor: '#F6F6F6' }}
            className={`flex-1 flex flex-col gap-[30px] overflow-y-scroll py-[38px] pr-[30px] ${styles.content}`}
          >
                    ...
                    {editProduct && (
                      <div className="w-28 h-28 mt-4">
                        <img
                          ...
                          src="https://i.pcmag.com/imagery/reviews/07t6yzTnRvFvs8uD2xeYsB0-1.fit_lim.size_320x180.v1639090940.jpg"
                          alt="product-img"
                        />
                      </div>
                    )}
