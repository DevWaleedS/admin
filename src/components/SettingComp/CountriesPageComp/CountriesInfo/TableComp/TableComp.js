...
function createData(id, name, nameEn, number) {
	return {
		id,
		name,
		nameEn,
...
const rows = [createData(1, 'المملكة العربية السعودية', 'Saudi Arabia', '966'), createData(2, 'فلسطين', 'Palestine', '972'), createData(3, 'الأردن', 'Jordon', '974')];
